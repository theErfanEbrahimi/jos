...
umain(int argc, char **argv)
{
  ...
  800041:	0f 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 9b 02 00 00       	call   8002e4 <sys_yield>
...
sys_ipc_recv(void *dstva)
{
  ...
  80011b:	68 2f 0f 80 00       	push   $0x800f2f
  800120:	6a 23                	push   $0x23
  800122:	68 4c 0f 80 00       	push   $0x800f4c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800180:	68 2f 0f 80 00       	push   $0x800f2f
  800185:	6a 23                	push   $0x23
  800187:	68 4c 0f 80 00       	push   $0x800f4c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8001c2:	68 2f 0f 80 00       	push   $0x800f2f
  8001c7:	6a 23                	push   $0x23
  8001c9:	68 4c 0f 80 00       	push   $0x800f4c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800204:	68 2f 0f 80 00       	push   $0x800f2f
  800209:	6a 23                	push   $0x23
  80020b:	68 4c 0f 80 00       	push   $0x800f4c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800246:	68 2f 0f 80 00       	push   $0x800f2f
  80024b:	6a 23                	push   $0x23
  80024d:	68 4c 0f 80 00       	push   $0x800f4c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800288:	68 2f 0f 80 00       	push   $0x800f2f
  80028d:	6a 23                	push   $0x23
  80028f:	68 4c 0f 80 00       	push   $0x800f4c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8002cb:	68 2f 0f 80 00       	push   $0x800f2f
  8002d0:	6a 23                	push   $0x23
  8002d2:	68 4c 0f 80 00       	push   $0x800f4c
...
sys_env_destroy(envid_t envid)
{
  ...
  80034a:	68 2f 0f 80 00       	push   $0x800f2f
  80034f:	6a 23                	push   $0x23
  800351:	68 4c 0f 80 00       	push   $0x800f4c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800385:	53                   	push   %ebx
  800386:	50                   	push   %eax
  800387:	68 5c 0f 80 00       	push   $0x800f5c
  ...
  80039a:	e8 15 00 00 00       	call   8003b4 <vcprintf>
	cprintf("\n");
  80039f:	c7 04 24 7f 0f 80 00 	movl   $0x800f7f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004ea:	0f be 80 81 0f 80 00 	movsbl 0x800f81(%eax),%eax
  8004f1:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800686:	50                   	push   %eax
  800687:	68 92 0f 80 00       	push   $0x800f92
  80068c:	57                   	push   %edi
  80068d:	56                   	push   %esi
  ...
  80069b:	52                   	push   %edx
  80069c:	68 9b 0f 80 00       	push   $0x800f9b
  8006a1:	57                   	push   %edi
  8006a2:	56                   	push   %esi
  ...
  8006c8:	bb 9e 0f 80 00       	mov    $0x800f9e,%ebx
				p = "(null)";
			if (width > 0 && padc != '-')
