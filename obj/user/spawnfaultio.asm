...
umain(int argc, char **argv)
{
  ...
  800068:	50                   	push   %eax
  800069:	68 86 23 80 00       	push   $0x802386
  80006e:	6a 09                	push   $0x9
  800070:	68 a0 23 80 00       	push   $0x8023a0
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800101:	53                   	push   %ebx
  800102:	50                   	push   %eax
  800103:	68 c0 23 80 00       	push   $0x8023c0
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800266:	0f be 80 e3 23 80 00 	movsbl 0x8023e3(%eax),%eax
  80026d:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800402:	50                   	push   %eax
  800403:	68 f4 23 80 00       	push   $0x8023f4
  800408:	57                   	push   %edi
  800409:	56                   	push   %esi
  ...
  800444:	bb fd 23 80 00       	mov    $0x8023fd,%ebx
				p = "(null)";
			if (width > 0 && padc != '-')
