	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ea:	0f be 80 68 0f 80 00 	movsbl 0x800f68(%eax),%eax
  8001f1:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002d2:	ff 24 85 a0 10 80 00 	jmp    *0x8010a0(,%eax,4)
  ...
  80037b:	8b 14 85 00 12 80 00 	mov    0x801200(,%eax,4),%edx
  800382:	85 d2                	test   %edx,%edx
  800384:	75 15                	jne    80039b <vprintfmt+0x143>
				printfmt(putch, putdat, "error %d", err);
  800386:	50                   	push   %eax
  800387:	68 79 0f 80 00       	push   $0x800f79
  80038c:	57                   	push   %edi
  80038d:	56                   	push   %esi
  ...
  80039b:	52                   	push   %edx
  80039c:	68 82 0f 80 00       	push   $0x800f82
  8003a1:	57                   	push   %edi
  8003a2:	56                   	push   %esi
  ...
  8003c8:	bb 85 0f 80 00       	mov    $0x800f85,%ebx
				p = "(null)";
			if (width > 0 && padc != '-')
...
sys_ipc_recv(void *dstva)
{
  ...
  8009e7:	68 5f 12 80 00       	push   $0x80125f
  8009ec:	6a 23                	push   $0x23
  8009ee:	68 7c 12 80 00       	push   $0x80127c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800a4c:	68 5f 12 80 00       	push   $0x80125f
  800a51:	6a 23                	push   $0x23
  800a53:	68 7c 12 80 00       	push   $0x80127c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800a8e:	68 5f 12 80 00       	push   $0x80125f
  800a93:	6a 23                	push   $0x23
  800a95:	68 7c 12 80 00       	push   $0x80127c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800ad0:	68 5f 12 80 00       	push   $0x80125f
  800ad5:	6a 23                	push   $0x23
  800ad7:	68 7c 12 80 00       	push   $0x80127c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b12:	68 5f 12 80 00       	push   $0x80125f
  800b17:	6a 23                	push   $0x23
  800b19:	68 7c 12 80 00       	push   $0x80127c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b54:	68 5f 12 80 00       	push   $0x80125f
  800b59:	6a 23                	push   $0x23
  800b5b:	68 7c 12 80 00       	push   $0x80127c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b97:	68 5f 12 80 00       	push   $0x80125f
  800b9c:	6a 23                	push   $0x23
  800b9e:	68 7c 12 80 00       	push   $0x80127c
...
sys_env_destroy(envid_t envid)
{
  ...
  800c16:	68 5f 12 80 00       	push   $0x80125f
  800c1b:	6a 23                	push   $0x23
  800c1d:	68 7c 12 80 00       	push   $0x80127c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c51:	53                   	push   %ebx
  800c52:	50                   	push   %eax
  800c53:	68 8c 12 80 00       	push   $0x80128c
  ...
  800c66:	e8 49 f4 ff ff       	call   8000b4 <vcprintf>
	cprintf("\n");
  800c6b:	c7 04 24 5c 0f 80 00 	movl   $0x800f5c,(%esp)
